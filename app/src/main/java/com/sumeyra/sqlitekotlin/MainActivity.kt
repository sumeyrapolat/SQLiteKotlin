package com.sumeyra.sqlitekotlin
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //SQLite işlemlerimiin hepsini try and catch blokları içinde yapmam gerek

            // 1- Database oluştur
            // 2- Database içine sheetleri ekle
            // 3- Veriyi Kaydetmek - Kodu çaıştırdıktan sonra bunu comment lien al sürekli eklemesin
            // 4- Veri çekmek : veri çekmek için Cursor yapısını kullanıyoruz.
            // 5- Cursor kullandıktan sonra cursor.close ile kapatmayı unutmayalım
            // 6- Id ile veri eklemek
            try {
